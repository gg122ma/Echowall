(function () {
  ...
  const patterns = Object.freeze({
    ...
    campus_fees: /\b(fee|fees|cost|costs|price|prices|how much|charge|charges|free|yuran|harga|berapa ringgit|percuma)\b|费用|收费|多少钱|免费/i,
  ...
  function classify(message) {
    ...
    if (/\bafter 7(?::00)?\s*pm\b|\bselepas 7(?::00)?\s*(?:malam|pm)\b|晚上七点后|晚上7点后/i.test(source)) return "campus_rules";
