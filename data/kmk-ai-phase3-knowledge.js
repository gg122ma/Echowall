(function () {
  ...
  const ENTITIES = freeze([
    ...
    freeze({ id: "koop-mart", title: "KOOP", aliases: freeze(["koop", "koop mart", "koperasi"]), mapState: "UNMAPPED", buildingId: "B_KOOP" }),
  ...
  const FACTS = freeze([
    ...
    fact("resource-centre.identity", "resource-centre", "identity", { en: "The source name is Bangunan Pusat Sumber dan Makmal Komputer.", ms: "Nama dalam sumber ialah Bangunan Pusat Sumber dan Makmal Komputer.", zh: "资料中的名称是 Bangunan Pusat Sumber dan Makmal Komputer。" }, [p("programmeRules", null)], { dimension: "identity" }),
