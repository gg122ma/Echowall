...
(function initializeCampusBuildingRegistry() {
  ...
  const CLICKABLE_PROVENANCE = Object.freeze({
    KMM:Object.freeze({
      nameAuthority:AUTHORITY.OFFICIAL,
      nameSourceDate:"2026-05-14",
      nameEvidence:"Official Peta Kolej building registry",
      geometryAuthority:AUTHORITY.SPATIAL,
    }),
    KMP:Object.freeze({
      nameAuthority:AUTHORITY.OFFICIAL,
      nameSourceDate:null,
      nameEvidence:"Current official KMP sources",
      geometryAuthority:AUTHORITY.SPATIAL,
    }),
    KMPK:Object.freeze({
      nameAuthority:AUTHORITY.SECONDARY,
      nameSourceDate:null,
      nameEvidence:"MPPB / hosted campus material",
      geometryAuthority:AUTHORITY.SPATIAL,
    }),
    KMPH:Object.freeze({
      nameAuthority:AUTHORITY.SECONDARY,
      nameSourceDate:null,
      nameEvidence:"Provisional topology; 18 May 2026 plan not recovered",
      geometryAuthority:AUTHORITY.SPATIAL,
    }),
  });
  const supported = (campusId, buildingId, name, category, lat, lng, wayId, coordinates, provenance) => record(campusId, buildingId, name, {
    category, coordinates:{ lat, lng }, geometry:polygon(wayId, coordinates),
    sourceAuthority:{
      name:provenance.nameAuthority,
      nameSourceDate:provenance.nameSourceDate,
      nameEvidence:provenance.nameEvidence,
      geometry:provenance.geometryAuthority,
    },
    geometryState:STATE.CLICKABLE,
  });
  ...
  const registry = {
    ...
    4:[
      supported(4,"KMPK_B_PUSAT_SUMBER","Pusat Sumber","Library",4.44421,101.12948,"963726705",[[4.4444363,101.1293557],[4.444119,101.1297206],[4.4439813,101.1296001],[4.4442985,101.1292352],[4.4444363,101.1293557]],CLICKABLE_PROVENANCE.KMPK),
    ...
    5:[
      supported(5,"KMP_B_PUSAT_PELAJAR","Pusat Pelajar","Student centre",6.44378,100.27897,"1393737972",[[6.4438213,100.2788003],[6.4438932,100.2790913],[6.443752,100.2791409],[6.443672,100.2788325],[6.4438199,100.2787896],[6.4438213,100.2788003]],CLICKABLE_PROVENANCE.KMP),
      supported(5,"KMP_B_DEWAN_SRI_KAYANGAN","Dewan Sri Kayangan","Hall",6.44281,100.27972,"737230759",[[6.4429635,100.2794968],[6.4429731,100.2795347],[6.4430491,100.279515],[6.443127,100.2798193],[6.4430245,100.2798458],[6.4430174,100.2798181],[6.4425744,100.2799328],[6.442494,100.2796184],[6.4429635,100.2794968]],CLICKABLE_PROVENANCE.KMP),
      supported(5,"KMP_B_PEPERIKSAAN","Bangunan Peperiksaan","Academic building",6.44242,100.28104,"737230762",[[6.4422242,100.2808646],[6.4422186,100.2812847],[6.4423894,100.281287],[6.4423888,100.2811877],[6.4424051,100.281186],[6.442459,100.2811839],[6.4424584,100.2812253],[6.4426058,100.2812273],[6.4426114,100.2808001],[6.4424679,100.2807982],[6.4424663,100.2809171],[6.4424139,100.2809164],[6.4424146,100.2808672],[6.4423865,100.2808689],[6.4422242,100.2808646]],CLICKABLE_PROVENANCE.KMP),
