-- Switch the photo URL allowlist to the active EchoWall Cloudinary environment.
-- This migration changes no rows and does not broaden the allowed hostname.
...
alter table app.media_assets
  ...
  add constraint media_assets_secure_url_check check (
    secure_url is null
    or secure_url ~ '^https://res[.]cloudinary[.]com/Irx0uf7z/image/upload/'
  );
...
begin
  if p_media_public_id is null
     ...
     or p_media_secure_url !~ '^https://res[.]cloudinary[.]com/Irx0uf7z/image/upload/'
