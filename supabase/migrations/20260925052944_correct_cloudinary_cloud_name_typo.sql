-- Correct the active Cloudinary cloud name from uppercase I to lowercase l.
-- This migration changes only the accepted delivery URL prefix.
...
alter table app.media_assets
  ...
  add constraint media_assets_secure_url_check check (
    secure_url is null
    or secure_url ~ '^https://res[.]cloudinary[.]com/lrx0uf7z/image/upload/'
  );
...
begin
  if p_media_public_id is null
     ...
     or p_media_secure_url !~ '^https://res[.]cloudinary[.]com/lrx0uf7z/image/upload/'
